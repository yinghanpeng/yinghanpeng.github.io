...
const langGraphMarkdownFiles = [
  '01-LangGraph基础入门.md',
  '02-LangGraph控制流与节点执行.md',
  '03-LangGraph持久化与记忆管理.md',
  '04-LangGraph中断与工具与部署.md',
  '05-LangGraph高级特性.md'
].map((file) => join(root, 'content/langgraph-study-notes', file));
const langGraphContentHtml = execFileSync(
  'python3',
  [join(root, 'tools/render-markdown.py'), ...langGraphMarkdownFiles],
  { encoding: 'utf8' }
);
...
const posts = [
  {
    ...
    summary: '原样发布五份 LangGraph Markdown 学习笔记，包含基础入门、控制流、持久化、中断、工具、部署与高级特性。',
    tags: ['LangGraph', 'LangChain', '学习笔记'],
    minutes: 120,
    contentHtml: langGraphContentHtml
  },
  {
