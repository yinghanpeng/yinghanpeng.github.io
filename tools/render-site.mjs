...
function renderMarkdown(file) {
  return execFileSync(
    'python3',
    [join(root, 'tools/render-markdown.py'), join(root, 'content/langgraph-study-notes', file)],
    { encoding: 'utf8' }
  );
}

const langGraphOverviewHtml = renderMarkdown('01-LangGraph基础入门.md');
const langGraphControlFlowHtml = renderMarkdown('02-LangGraph控制流与节点执行.md');
const langGraphPersistenceHtml = renderMarkdown('03-LangGraph持久化与记忆管理.md');
const langGraphInterruptHtml = renderMarkdown('04-LangGraph中断与工具与部署.md');
const langGraphAdvancedBackupHtml = renderMarkdown('05-LangGraph高级特性_backup.md');
const langGraphAdvancedHtml = renderMarkdown('05-LangGraph高级特性.md');
...
const posts = [
  {
    title: '1. LangGraph总览',
    url: '/2025/05/13/langgraph-overview/',
    date: '2025-05-13',
    datetime: '2025-05-13T20:00:00+08:00',
    updated: '2025-05-13',
    updatedDatetime: '2025-05-13T20:00:00+08:00',
    summary: '原样发布《01-LangGraph基础入门.md》的 Markdown 内容。',
    tags: ['LangGraph', 'LangChain', '学习笔记'],
    minutes: 20,
    contentHtml: langGraphOverviewHtml
  },
  {
    title: '4. 控制流',
    url: '/2025/05/16/langgraph-control-flow/',
    date: '2025-05-16',
    datetime: '2025-05-16T20:00:00+08:00',
    updated: '2025-05-16',
    updatedDatetime: '2025-05-16T20:00:00+08:00',
    summary: '原样发布《02-LangGraph控制流与节点执行.md》的 Markdown 内容。',
    tags: ['LangGraph', '控制流', '学习笔记'],
    minutes: 45,
    contentHtml: langGraphControlFlowHtml
  },
  {
    title: '6. 持久化机制和可恢复执行',
    url: '/2025/05/19/langgraph-persistence-memory/',
    date: '2025-05-19',
    datetime: '2025-05-19T20:00:00+08:00',
    updated: '2025-05-19',
    updatedDatetime: '2025-05-19T20:00:00+08:00',
    summary: '原样发布《03-LangGraph持久化与记忆管理.md》的 Markdown 内容。',
    tags: ['LangGraph', '持久化', '学习笔记'],
    minutes: 55,
    contentHtml: langGraphPersistenceHtml
  },
  {
    title: '8. 中断',
    url: '/2025/05/22/langgraph-interrupt-tools-deployment/',
    date: '2025-05-22',
    datetime: '2025-05-22T20:00:00+08:00',
    updated: '2025-05-22',
    updatedDatetime: '2025-05-22T20:00:00+08:00',
    summary: '原样发布《04-LangGraph中断与工具与部署.md》的 Markdown 内容。',
    tags: ['LangGraph', '中断', '学习笔记'],
    minutes: 45,
    contentHtml: langGraphInterruptHtml
  },
  {
    title: '11. 流式执行',
    url: '/2025/05/25/langgraph-advanced-features-backup/',
    date: '2025-05-25',
    datetime: '2025-05-25T20:00:00+08:00',
    updated: '2025-05-25',
    updatedDatetime: '2025-05-25T20:00:00+08:00',
    summary: '原样发布《05-LangGraph高级特性_backup.md》的 Markdown 内容。',
    tags: ['LangGraph', '高级特性', '学习笔记'],
    minutes: 120,
    contentHtml: langGraphAdvancedBackupHtml
  },
  {
    title: '11. 流式执行',
    url: '/2025/05/28/langgraph-advanced-features/',
    date: '2025-05-28',
    datetime: '2025-05-28T20:00:00+08:00',
    updated: '2025-05-28',
    updatedDatetime: '2025-05-28T20:00:00+08:00',
    summary: '原样发布《05-LangGraph高级特性.md》的 Markdown 内容。',
    tags: ['LangGraph', '高级特性', '学习笔记'],
    minutes: 70,
    contentHtml: langGraphAdvancedHtml
  },
  {
    ...
    tags: ['AI Engineering', 'PDF', '资料收藏'],
    minutes: 1,
    contentHtml: `
      <h2 id="attachment">附件说明</h2>
  ...
  },
  {
    ...
    tags: ['转载阅读', 'Skill', 'Harness Engineering'],
    minutes: 7,
    contentHtml: `
  ...
  },
  {
    ...
    tags: ['转载阅读', 'Harness Engineering', 'AI Coding'],
    minutes: 7,
    contentHtml: `
      <h2 id="copyright">转载说明</h2>
